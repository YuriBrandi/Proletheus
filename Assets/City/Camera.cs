...
{
    public Transform missile; // Il missile che la telecamera seguirà
    public Vector3 offset = new Vector3(0, 10, -20); // Posizione relativa della camera rispetto al missile
    public float smoothSpeed = 0.125f; // Velocità di interpolazione della posizione della telecamera
    ...
    void LateUpdate()
    {
        ...
        // Lerp per rendere il movimento della telecamera più fluido
