...
This University work consists of a simple Multi-ML-agent setup composed of:
...
4. E.M. come from all cardinal directions
5. E.M. come from all cardinal and intercardinal directions
